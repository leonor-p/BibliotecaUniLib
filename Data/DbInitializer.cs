            ...
            var categories = new Category[]
           {
            ...
            var courses = new Course[]
            {
                ...
                new Course
                {
                    ...
                    Description="Uma assistente dedicada descobre um segredo chocante sobre seu chefe. O que começa como uma simples desconfiança logo se transforma em uma luta por sua própria segurança.",
                    CoverPhoto= "a-hipotese-do-amor.jpg",
                    Author="Ali Hazelwood",
                    ISBN="978-0593-3368-00",
                    Addrec=true,
                    Dest=false,
                    Quantidade=50,
                    State=true,
                ...
                new Course
                {
                    ...
                    Description="Dois estranhos dividem um apartamento, mas nunca se encontram devido a seus horários opostos. À medida que começam a se comunicar por bilhetes, um vínculo inesperado surge, desafiando suas rotinas.",
                    CoverPhoto="apartamento-partilha-se-1.jpg",
                    Author="Beth O'Leary",
                    ISBN="978-1784-1712-85",
                    Addrec=false,
                    Dest=false,
                    Quantidade=50,
                    State=true,
                ...
                new Course
                {
                    ...
                    Description="Adeline é sequestrada por um homem perigoso e precisa enfrentar seus próprios medos e segredos sombrios enquanto luta para sobreviver em um mundo cheio de suspense e terror psicológico.",
                    CoverPhoto= "a-sombra-de-adeline.jpg",
                    Author="H. D. Carlton",
                    ISBN="978-1989-8187-92",
                    Addrec=true,
                    Dest=false,
                    Quantidade=50,
                    State=true,
